...
class PickImageCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final image =
        getFile(ref.watch(AddLoanTransactionProvider.imagePathProvider));
          ...
          children: [
            ...
            if (image != null && editable)
              _Type(
                ...
                color: Colors.red,
                onTap: () => ref
                    .read(AddLoanTransactionProvider.imagePathProvider.notifier)
                    .update((state) => null),
              ),
            if (editable)
              Row(
  ...
  Future<void> takePhoto(ImageSource source, Reader read) async {
    ...
    pickedFile?.let(
      (value) => read(AddLoanTransactionProvider.imagePathProvider.notifier)
