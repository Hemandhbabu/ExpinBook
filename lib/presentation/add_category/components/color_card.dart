...
class ColorCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final color = ref.watch(AddCategoryProvider.colorProvider);
    ...
    return AddEditInfoCard(
      ...
      onTap: editable
          ? () => showColorPicker(
                      context, ref.read(AddCategoryProvider.colorProvider))
                  .then(
                (value) => value?.let(
                  (value) => ref
                      .read(AddCategoryProvider.colorProvider.notifier)
                      .update((state) => value),
                ),
              )
          : null,
