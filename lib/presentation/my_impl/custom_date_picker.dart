...
import 'package:expin_book/presentation/core_package/core_widget.dart';
import 'package:expin_book/utils/base_extensions.dart';
import 'package:expin_book/utils/my_datetime.dart';
import 'package:expin_book/utils/theme.dart';
...
const Size _calendarPortraitDialogSize = Size(330.0, 436.0);
...
class _CustomDatePickerDialogState extends State<CustomDatePickerDialog>
  ...
  late final RestorableTimeOfDay _selectedTimeOfDay =
      RestorableTimeOfDay(widget.timeOfDay ?? TimeOfDay.now());
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    registerForRestoration(_selectedTimeOfDay, 'selected_time');
  }
  ...
  void _handleOk() {
    Navigator.pop(
      context,
      _selectedDate.value.copyTimeOfDay(_selectedTimeOfDay.value),
    );
  }
  ...
  void _handleTimeChanged(TimeOfDay timeOfDay) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    // );
    final timeOfDay =
        widget.timeOfDay != null ? _selectedTimeOfDay.value : null;
        ...
        children: [
          if (timeOfDay != null)
            TextButton.icon(
              ...
              ).then((value) => value?.let(_handleTimeChanged)),
              icon: const Icon(Icons.schedule_rounded),
              label: const Text('Select time'),
            ),
          if (timeOfDay != null) const SizedBox(height: 8),
          ElevatedButton(
            onPressed: _handleOk,
    ...
    return AnimatedContainer(
      ...
      height: dialogSize.height + (timeOfDay != null ? 56 : 0),
...
class _DateRangePickerDialogState extends State<DateRangePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final contents = _CalendarRangePickerDialog(
      key: _calendarPickerKey,
    ...
    const insetPadding = EdgeInsets.zero;
